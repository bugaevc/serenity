...
String IPv4Socket::absolute_path(const FileDescription& description) const
{
    SocketRole role = description.socket_role();
    ...
    if (role == SocketRole::Accepted || role == SocketRole::Connected)
